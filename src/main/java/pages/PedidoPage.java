...
public class PedidoPage {
	...
	private By textoPedidoConfirmado = By.cssSelector("#content-hook_order_confirmation h3.card-title");
	private By email = By.cssSelector("#content-hook_order_confirmation p");
	private By totalProdutos = By.cssSelector("#order-items div.order-line div.row div.bold");
	private By totalTaxIncl = By.cssSelector("#order-items table tr.total-value td:nth-child(2)");
